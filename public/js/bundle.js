...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiZmlzY281NyIsImEiOiJjbDU4bzRkODAwcnBxM21xbnloOHZ5MTB2In0.XMbWukOhRvaVrVbJd63MSQ";
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)("error", "Error trying to logout");
...
var stripe = Stripe('pk_test_51LO98PKgA5MfpJ4TlZz048izPBE7RK5eGvbK8GJQ5AETA46OkSXsGVLbmBZpBXExrSoBasSmUxFkFcLnN6jGUGTU00yCeYeixG');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //create checkout from  + channel credit card
...
} // document.getElementById("photo").addEventListener("change", handleFiles, false);
// function handleFiles() {
//   const fileList = this.files;
//   console.log(fileList[0].name);
//   if(fileList){
//     document.getElementById('photoLabel').textContent=fileList[0].name
//   }
// }
